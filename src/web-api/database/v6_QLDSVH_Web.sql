...
INSERT INTO `heritages` (`id`, `name`, `heritage_type_id`, `description`, `location_id`, `image_url`, `management_unit_id`, `time`, `urlslug`, `heritage_category_id`, `video_url`, `short_description`, `360_image_url`, `view_count`) VALUES
