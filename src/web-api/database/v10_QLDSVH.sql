...
(23, 'Tiêu đề mô tả 1', 67, 'Mô tả di sản 1', '', 'Mô tả hình ảnh 1'),
(24, 'Tiêu đề mô tả 2', 67, 'Mô tả di sản 2', 'https://images.unsplash.com/photo-1519955045385-7cdb8e07c76f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8aGVyaXRhZ2V8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60', 'Mô tả hình ảnh 2');
...
(67, 'Tên di sản', 1, 1, 1, '', 'url-slug', 1, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum', '', 0, NULL);
